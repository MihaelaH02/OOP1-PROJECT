...
public class AddSpecialties {
    public void addSpecialties() throws InvalidEnteredDataExceptions {
        ...
        sit.addElement(new Discipline("Specialized sports training - 1 part",TypeOfTheDiscipline.OPTIONAL),1);
        ...
        sit.addElement(new Discipline("Specialized sports training - 4 part",TypeOfTheDiscipline.OPTIONAL),2);
        ...
        kst.addElement(new Discipline("Specialized sports training - 1 part",TypeOfTheDiscipline.OPTIONAL),1);
        ...
        kst.addElement(new Discipline("WEB design",TypeOfTheDiscipline.MANDATORY),2);
        ...
        kst.addElement(new Discipline("Specialized sports training - 3 part",TypeOfTheDiscipline.OPTIONAL),2);
        ...
        kst.addElement(new Discipline("Optional discipline - project3",TypeOfTheDiscipline.OPTIONAL),3);
        ...
        kst.addElement(new Discipline("Optional discipline - project4",TypeOfTheDiscipline.OPTIONAL),4);
